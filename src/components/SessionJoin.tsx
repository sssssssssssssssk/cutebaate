...
const SessionJoin: React.FC<SessionJoinProps> = ({ onSessionJoined }) => {
    ...
    <div className="w-full max-w-md mx-auto">
      <div className="bg-white rounded-2xl shadow-2xl p-8">
        <div className="text-center mb-6">
          ...
          <h2 className="text-3xl font-bold text-gray-800 mb-2">Join Session</h2>
          <p className="text-gray-600">Enter the session credentials to connect</p>
        </div>
          ...
          <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-700">All messages are end-to-end encrypted. No data is stored on any server.</p>
              </div>
            </div>
          </div>
